...
提案フォームは **入力 → 確認 → 完了** の3ステップ。送信には2回クリックが要る:
1. 入力ページ: `#form_end`「同意して提案する」→ **確認ページ**へ
2. 確認ページ: 「**利用規約に同意して提案する**」→ **完了**(ここで実際に送信)

`#form_end` だけ押すと確認ページで止まり、応募は送信されない(2026-06-06に判明)。
